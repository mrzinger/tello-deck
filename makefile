...
all: main.cpp tello.cpp
	$(CC) -O2 $(CFLAGS) main.cpp tello.cpp video_out.cpp crc_utils.cpp src/input_controller.cpp -o tello $(LIBS)

debug: main.cpp tello.cpp
	$(CC) -g $(CFLAGS) main.cpp tello.cpp video_out.cpp crc_utils.cpp src/input_controller.cpp -o tello $(LIBS)
clean:
	rm -f tello
